...
public class Solution
{
    ...
    static class HenFactory {
        ...
        static Hen getHen(String country) {
            if (country.equals(Country.RUSSIA)) {return new RussianHen(country);}
            else if (country.equals(Country.UKRAINE)) {return new UkrainianHen(country);}
            else if (country.equals(Country.MOLDOVA)) {return new MoldovanHen(country);}
            else if (country.equals(Country.BELARUS)) {return new BelarusianHen(country);}
            else return null;
        }
    }
